...
type healthcheck struct {
	...
	ProcStartTime            int64                              `json:"procStartTime"`      // check
	TrafficStartedTime       int64                              `json:"trafficStartedTime"` // first event
	ScanStartTime            int64                              `json:"scanStartTime"`      // first CC
}
